                ...
                <div class='row justify-content-center' style='margin-bottom: 60px;'>
                    <div class='col-lg-8'>
                        <div class='section-title title-style-three text-center mb-70'>
                            <h2 class='title'>Most Popular Movies You Search</h2>
                        </div>
                    </div>
                </div>
                <div class='row movie-item-row'>
                <?php
                    $movie=str_replace(" ","%20",$_REQUEST['movie']);
                    $curl = curl_init();
                    curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://imdb-api.com/en/API/Search/k_dk3eigk3/".$movie,
                    ...
                    for($index =0;$index<count($jsonvalue->results);$index++){
                        $id =$jsonvalue->results[$index]->id;
                        $str=$jsonvalue->results[$index]->image;
                        $name=$jsonvalue->results[$index]->title;
                        $description=$jsonvalue->results[$index]->description;
                        echo " 
